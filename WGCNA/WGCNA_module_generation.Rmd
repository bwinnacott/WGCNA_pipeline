...
par(mar = c(7, 10, 3, 3))
tiff('module_trait_relationship.tif',width=6,height=4,units='in',res = 300)
...
Save the module and trait information for identifying interesting genes and pathways.
