...
```{r TPM normalization}
# get length data
length_data <- read.table("~/bioinformatics/group-projects-invivo-fall-project/BGMP_IVB_2020_dataset/GC_lengths.tsv",
...
ID_table <- read.csv("~/bioinformatics/group-projects-invivo-fall-project/Cleaned_Datasets_transcript_stableID/celegans_cleaned_mart_ensembl.102.tsv", sep = "\t")
