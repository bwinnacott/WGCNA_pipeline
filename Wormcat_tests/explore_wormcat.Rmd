...
```{r get gene names from biomart, include=FALSE, echo=FALSE, results='hide'}
...
#fitting geralized linear model and preparing data for GO
...
#removing duplicate WormBase IDs
