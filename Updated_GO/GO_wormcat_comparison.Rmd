...
knitr::opts_knit$set(root.dir = '~/bioinformatics/Bi610_lab/InVivo/wormcat_resources/')
```
...
dge_data <- read.csv('worm_A_vs_C_lrt.csv',sep = ',',header = TRUE,row.names = 1)
head(dge_data)
```
...
write.csv(results_adjp_bp,'AvsC_term_enrichment_results_bp.csv')
write.csv(results_adjp_cc,'AvsC_term_enrichment_results_cc.csv')
write.csv(results_adjp_mf,'AvsC_term_enrichment_results_mf.csv')
```
