...
knitr::opts_knit$set(root.dir = '/Users/brendanwinnacott/bioinformatics/Bi610_lab/InVivo/wormcat_resources')
```
...
```{r}
# read in file
wormcat_mappings <- read.csv('B-vs-C_worm-cat_Oct-23-2020-01_39_15/rgs_and_categories.csv',row.names = 1,header = TRUE)
